...
(() => {
  ...
  const TR = {
    ...
    // hero
    "I'm an engineer who enjoys solving complex problems and building innovative, value-driven products.My career began in cybersecurity, then moved into embedded systems, and in recent years I've expanded into AI and web development.":
      "Karmaşık problemleri çözmeyi, yenilikçi ve değer odaklı ürünler geliştirmeyi seven bir mühendisim. Kariyerime siber güvenlik alanında başladım, ardından gömülü sistemlere geçtim ve son yıllarda AI ve web geliştirme alanında da kendimi geliştirdim.",

    // education
    "Master's Degree": "Yüksek Lisans",
    "Artificial Intelligence and Robotics": "Yapay Zeka ve Robotik",
    "Master's Degree / Artificial Intelligence and Robotics": "Yüksek Lisans / Yapay Zeka ve Robotik",
    "In September 2026, I began my master's degree in Artificial Intelligence and Robotics at Fırat University, where I am continuing to develop my knowledge and expertise in artificial intelligence, robotics, and related technologies.":
      "Eylül 2026'da Fırat Üniversitesi'nde Yapay Zeka ve Robotik alanında yüksek lisans eğitimime başladım. Eğitimime devam ederken yapay zeka, robotik ve ilgili teknolojiler alanındaki bilgi ve uzmanlığımı geliştirmeye devam ediyorum.",
    "Bachelor's Degree": "Lisans",
    "High School": "Lise",
    "Elementary / Middle School": "İlkokul/ Ortaokul",
    "Through the university entrance exam, I was admitted to Fırat University — home to Turkey's first Software Engineering department — and graduated in 2025 with a GPA of 2.77. I'm proud to have studied at this institution and continue to build on the foundation it gave me.":
      "Üniversite giriş sınavı sonucunda, Türkiye'nin ilk Yazılım Mühendisliği bölümünü açan Fırat Üniversitesi'ne kabul edildim ve buradan 2025 yılında 2.77 not ortalaması ile mezun oldum. Bu kurumda eğitim almaktan gurur duyuyorum ve edindiğim temeli daha da ileriye taşıyorum.",
    "As a result of the TEOG exam, I succeeded in placing within the top 5% in Turkey, which allowed me to gain admission to Cumhuriyet Anatolian High School. I particularly excelled in my quantitative subjects and graduated with a GPA of 78.6.":
    ...
    "Recently, as a freelancer, I've been assisting a company with web scraping tasks, providing software consulting, and offering Python-based application solutions. I also generate income by building practical, problem-solving tools for clients.":
      "Son zamanlarda serbest çalışan olarak bir şirkete web kazıma görevlerinde yardımcı oluyor, yazılım danışmanlığı veriyor ve Python uygulama çözümleri sunuyorum. Ayrıca müşteriler için pratik ve sorun çözücü araçlar geliştirerek gelir elde ediyorum.",
    "IT Specialist | Project Assistant": "BT Uzmanı | Proje Asistanı",
    "GOPA Worldwide Consultants": "GOPA Worldwide Consultants",
    "I provided consultancy on IT infrastructure, website setup, server room installation, data analysis, software requirements, and software-related matters. By supporting communication and stakeholder coordination, I helped ensure smooth project delivery.":
      "BT altyapısı, web sitesi kurulumu, sunucu odası kurulumu, veri analizi, yazılım gereksinimleri ve yazılım konularında danışmanlık sağladım. İletişim ve paydaş koordinasyonunu destekleyerek proje teslimatının sorunsuz ilerlemesine katkıda bulundum.",
    "Artificial Intelligence Engineer Intern": "Yapay Zeka Mühendisi Stajyeri",
    "As an AI Engineer Intern, I worked on a chatbot product that translates SQL queries into natural language, focusing on developing algorithms for data analysis and improving decision-making systems.":
      "Yapay Zeka Mühendisi Stajyeri olarak, SQL sorgularını doğal dile çeviren bir chatbot ürünü üzerinde çalıştım. Veri analizi için algoritmalar geliştirmeye ve karar verme sistemlerini iyileştirmeye odaklandım.",
    ...
    "I participated in a one-month internship, focusing on various software development projects. This experience helped me enhance my coding skills and gain practical knowledge in software engineering.":
      "Bir aylık staj programına katılarak çeşitli yazılım geliştirme projelerinde yer aldım. Bu deneyim kodlama becerilerimi geliştirmeme ve yazılım mühendisliğinde pratik bilgi kazanma fırsatı verdi.",
    "Computer Vision Engineer Intern": "Bilgisayarlı Görü Mühendisi Stajyeri",
    "My second internship was at Başaran İleri Teknoloji, a branch of Aselsan located in Malatya. I worked in the telecommunications field and developed a small-scale image processing and facial recognition project.":
      "İkinci stajımı Malatya'da bulunan Aselsan bayisi Başaran İleri Teknoloji'de yaptım. Telekomünikasyon alanında çalıştım ve küçük ölçekli bir görüntü işleme ve yüz tanıma projesi geliştirdim.",
    "Embedded Systems Engineer Intern": "Gömülü Sistemler Mühendisi Stajyeri",
    "My first internship experience took place at Tümer Engineering, located in Hacettepe Technopolis. I worked on an AHRS system project for avionics systems, specifically for UAVs, in the defense industry.":
      "İlk staj deneyimimi Hacettepe Teknokent'te bulunan Tümer Mühendislik'te yaşadım. Savunma sanayisinde, özellikle İHA'lara yönelik aviyonik sistemler için bir AHRS sistemi projesinde çalıştım.",

    // services
    "Python Developer": "Python Geliştirici",
    "As a Python Developer, I specialize in designing and developing robust applications using Python. With a strong foundation in various Python libraries and frameworks, I excel in creating scalable, efficient, and maintainable software solutions.":
      "Python Geliştirici olarak Python ile sağlam uygulamalar tasarlama ve geliştirme konusunda uzmanlaşıyorum. Çeşitli Python kütüphaneleri ve framework'lerindeki güçlü temelim sayesinde ölçeklenebilir, verimli ve sürdürülebilir yazılım çözümleri üretiyorum.",
    "Java Developer": "Java Geliştirici",
    "As a Java Developer, I focus on building high-performance, scalable applications using Java. My expertise includes Spring Boot, backend APIs, and enterprise-grade application design.":
      "Java Geliştirici olarak Java ile yüksek performanslı ve ölçeklenebilir uygulamalar geliştirmeye odaklanıyorum. Uzmanlığım Spring Boot, arka uç API'leri ve kurumsal seviyede uygulama tasarımına kadar uzanıyor.",
    "Web Developer": "Web Geliştirici",
    "As a front-end developer, I excel in creating visually appealing and user-friendly websites using HTML, CSS, and JavaScript. I am skilled in building responsive layouts, implementing interactivity, and delivering polished user experiences.":
      "Front-end geliştirici olarak HTML, CSS ve JavaScript kullanarak görsel açıdan çekici ve kullanıcı dostu web siteleri oluşturuyorum. Duyarlı tasarımlar kurmak, etkileşim eklemek ve estetik kullanıcı deneyimleri sunmak konusunda başarılıyım.",
    "Machine Learning Engineer": "Makine Öğrenmesi Mühendisi",
    "As a Machine Learning Engineer, I specialize in designing, developing, and deploying machine learning models to solve complex problems and drive data-driven decisions. My expertise includes feature engineering, model evaluation, and AI productization.":
      "Makine Öğrenmesi Mühendisi olarak karmaşık problemleri çözmek ve veriye dayalı kararlar almak için makine öğrenmesi modelleri tasarlayıp geliştiriyorum. Özellik mühendisliği, model değerlendirmesi ve yapay zeka ürünleştirmesi alanında uzmanlaşıyorum.",
    "Embedded Systems Developer": "Gömülü Sistemler Geliştirici",
    "As an Embedded Systems Developer, I specialize in designing and implementing robust embedded solutions for various applications. My expertise includes microcontrollers, real-time systems, and hardware-software integration.":
      "Gömülü Sistemler Geliştirici olarak farklı uygulamalar için sağlam gömülü çözümler tasarlıyor ve hayata geçiriyorum. Mikrodenetleyiciler, gerçek zamanlı sistemler ve donanım-yazılım entegrasyonu alanında uzmanlaşıyorum.",
    "Software Tester": "Yazılım Test Uzmanı",
    "As a Software Tester, I am dedicated to ensuring the quality and reliability of software applications through comprehensive testing and evaluation. My expertise includes manual and automated testing workflows.":
      "Yazılım Test Uzmanı olarak kapsamlı test ve değerlendirmelerle yazılım uygulamalarının kalitesini ve güvenilirliğini sağlamaya çalışıyorum. Manuel ve otomatik test akışları konusunda deneyim sahibiyim.",
    "Cybersecurity Engineer": "Siber Güvenlik Mühendisi",
    "As a Cybersecurity Engineer, I am committed to protecting organizations from cyber threats and ensuring the security of their digital assets.":
      "Siber Güvenlik Mühendisi olarak kurumları siber tehditlerden korumaya ve dijital varlıklarının güvenliğini sağlamaya odaklanıyorum.",
    "Data Scientist / Data Engineer / Web Scraper": "Veri Bilimci / Veri Mühendisi / Web Scraper",
    "As a Data Scientist, Data Engineer, and Web Scraper, I specialize in extracting, processing, and analyzing data to drive informed decision-making and uncover valuable insights.":
      "Veri Bilimci, Veri Mühendisi ve Web Scraper olarak veriyi çıkarma, işleme ve analiz etme konusunda uzmanlaşıyorum; böylece bilinçli kararlar alınmasını sağlıyor ve değerli içgörüler keşfediyorum."
  };
